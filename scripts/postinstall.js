...
data.push("tests.schema = " + fs.readFileSync("schemas/base.json") + ";\n\n");
data.push("exports.fixtures = tests.fixtures;\n");
data.push("exports.schema = tests.schema;\n");
...
function getLineData (fpath, isFile) {
  if (isFile) {
    return "// including file: " + fpath + "\n" +
      pathToObjName(fpath) + " = " + fs.readFileSync(fpath) + ";\n\n";
  } else {
