...
var _validate_common = function (_input, _inputs, _field, _fn) {
  ...
  rv = _validate_validations(_input, _inputs, _field);
 ...
 *   This function is *not* asynchronous.
 */
var _validate_javascript_validation = function (_input, _inputs, _field,
                                                _validation, _fn) {

  if (!_evaluate_expression(_validation, _input, _inputs, _field).result) {
    return {
...
var _evaluate_expression = function (_expression, _input, _inputs, _field) {
  return util.exec(
    'return ' + _expression, 
    { input: _input, inputs: _inputs, field: _field }, 
    this
  );
}
...
var _validate_javascript_condition = function (_input, _inputs, 
  ...
  if (_evaluate_expression(_condition, _input, _inputs, _field).result) {
...
exports.validate_any = function (_input, _field,
  ...
  if (!options.force_required) {
    ...
    if (util.is_plain_object(required) && required.javascript) {
      required = _evaluate_expression(
        required.javascript, _input, _inputs, _field
      ).result;
    }
  ...
  return async.waterfall([
    ...
    if (_rv.valid && !_rv.skipped && !_field.repeat && _field.type !== 'fields') {
