...
var _validate_repeat = function (_input, _field, _item_fn, _fn) {
  ...
  return async.eachSeries(
    ...
    function (_input_item, _next_fn) {
      ...
      _item_fn.call(this, _input_item, _field, i, function (_r) {
...
exports.validate_select = function (_input, _field, _fn) {
  ...
  return async.eachSeries(
    ...
    /* Per-item callback */
    function (_item, _next_fn) {

      /* Count selection-list items */
      ++i;

      /* Paranoia: should be normalized */
      if (!_.isArray(_item) || _item.length != 2) {
        return _next_fn.call(this, {
    ...
    function (_err) {
      ...
      /* Finish validating:
       *   The `_err` parameter will be false-like if all of the
       *   selection-list items are properly-formatted; check if
       *   the input provided is in the validated selection list. */
...
exports.validate_image = function (_input, _field, _fn) {
  ...
  /* Are we running server-side?
   *   If not, we can't do anything more, so the image validates. */
  ...
  mmmagic.detect(buf, function (_err, _result) {
