 ...
 */
var _validate_javascript_validation = function (_input, _field, _rule) {

  var args = {
    input: _input, field: _field
  };

  if (!util.exec('return ' + _rule, args, this).result) {
    return {
      valid: false, validation: _rule,
 ...
 */
var _validate_structured_condition = function (_condition_id,
                                               _condition_value, _inputs) {
  return { 
    valid: true, 
...
exports.validate_any = function (_input, _field, _inputs, _force_required) {
  ...
  if (!_force_required) {
    ...
    if (!required && (is_omitted_string || util.is_omitted_value(_input))) {
      return { valid: true, omitted: true };
    }
  }
