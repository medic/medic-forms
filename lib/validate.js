...
var _validate_fieldset = function (_map, _fields, _context, _fn) {
  ...
  return async.eachSeries(
    ...
    function (_field, _next_fn) {
      ...
      /* Check default value:
       *   This is asynchronous due to the fact that the default value
       *   checking in `_validate_default_property` depends upon the
       *   `input` module's (asynchronous) input validation functions. */

      return _validate_default_property(_field, function (_rv) {
...
exports.validate_required_property = function (_field, _fn) {
  ...
  return _fn.call(this, { valid: _.isBoolean(_field.required) });
};
...
exports.validate_repeat_property = function (_field, _fn) {
  ...
  if (_.isBoolean(repeat) || _.isInteger(repeat)) {
    return _fn.call(this, { valid: true });
  }
  ...
  if (!_.isArray(repeat)) {
    return _fn.call(this, {
      valid: false,
      error: 'Repeat specifier must be boolean, integer, or array'
    });
  }
  ...
  if (length < 1 || length > 2) {
    return _fn.call(this, {
      valid: false,
      error: 'Repeat specifier array must contain one or two items'
    });
  }
