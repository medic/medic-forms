...
var _normalize_conditions_property = function (_field, _default_language) {
  ...
  if (util.is_omitted_value(_field.conditions.structured)) {
    _field.conditions.structured = {};
  } else if (_.isString(_field.conditions.structured)) {
    var name = _field.conditions.structured;
    _field.conditions.structured = {};
    _field.conditions.structured[name] = true;
  }
  return _field;
};
