 ...
 */
var _normalize_field_identifiers = function (_field, _default_language) {

  if (_is_omitted(_field.name)) {
    _field.name = _field.id;
  }

  if (_is_omitted(_field.description)) {
    _field.description = _field.name;
  }

  _field.name = _normalize_l10n_string(
    _field.name, _default_language
  );

  _field.description = _normalize_l10n_string(
    _field.description, _default_language
  );
...
var _normalize_fieldset = function (_fields, _default_language) {
  ...
  for (var i = 0, len = _fields.length; i < len; ++i) {
    ...
    _normalize_field_identifiers(field, _default_language);
